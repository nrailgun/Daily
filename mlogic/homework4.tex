...
\begin{prooftree}
\AxiomC{*}
\UnaryInfC{$A \Rightarrow \lnot A \}$}
\UnaryInfC{$\Rightarrow \{ (A \lor \lnot A) \}$}
\UnaryInfC{$\Gamma \Rightarrow \{ (A \lor \lnot A) \} \cup \Delta$}
\UnaryInfC{$\Gamma \Rightarrow \{ B \} \cup \Delta$}

\AxiomC{$\Gamma \cup \{ (A \lor \lnot A) \} \Rightarrow \Delta$}
\UnaryInfC{$\Gamma \cup \{ B \} \Rightarrow \Delta$}
