...
\begin{prooftree}
	\AxiomC{*}
	\UnaryInfC{$Fx_0, Gx_0 \Rightarrow Fx_0$}
	\UnaryInfC{$(Fx_0 \land Gx_0) \Rightarrow Fx_0$}
	\UnaryInfC{$\forall x (Fx \land Gx) \Rightarrow Fx_0$}
	\UnaryInfC{$\forall x (Fx \land Gx) \Rightarrow \forall x Fx$}
	
	\AxiomC{*}
	\UnaryInfC{$Fx_0, Gx_0 \Rightarrow Gx_0$}
	\UnaryInfC{$(Fx_0 \land Gx_0) \Rightarrow Gx_0$}
	\UnaryInfC{$\forall x (Fx \land Gx) \Rightarrow Gx_0$}
	\UnaryInfC{$\forall x (Fx \land Gx) \Rightarrow \forall x Gx$}
	
	\BinaryInfC{$\forall x (Fx \land Gx) \Rightarrow \forall x Fx \land \forall x Gx$}
\end{prooftree}
